---
layout: post
title: Bolinger band with python 
permalink: /2021-06-25-Bolinger-Band/
---

### Bolinger Band (BB)

The bolinnger band is mening of standard deviation with calculation of moving average during 20, 60, and 120.
...
![image info](./Image/example_fig_BB.png)
...
For using Boliner band, we can make model and select ticker in index (Dow, S&P500 etc)?
...
If you satisfied this post you should check [Github](https://github.com/hanseopark/Stock/tree/master/BolingerBands) and please **Star** :)
